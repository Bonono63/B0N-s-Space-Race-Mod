...
public enum CustomArmorMaterials implements ArmorMaterial {
    ...
    BASIC_ASTRONAUT("basic_astronaut", 5, new int[]{3,4,3,2}, 1, SoundEvents.BLOCK_WOOL_PLACE, 4.0F, () -> {
        return Ingredient.ofItems(BSRItems.LEAD_INGOT);
    });
    ...
    CustomArmorMaterials(String name, int durabilityMultiplier, int[] armorValueArr, int enchantability, SoundEvent soundEvent, float toughness, Supplier<Ingredient> repairIngredient) {
        this.name = name;
